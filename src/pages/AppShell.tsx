...
export default function AppShell() {
  ...
  const visibleItems = navItems.filter((item) => !item.ownerOnly || can(role, item.to === '/analytics' ? 'reports' : 'userManagement'))
